      ...
      <div className="w-[85vw] md:w-[33vw] max-h-[88vh] bg-white overflow-y-auto rounded-xl shadow-md shadow-gray-700/50">
        <div className="flex justify-between items-center py-3 px-5 border-b-2 border-[#02457A]/50">
          <div className="flex flex-col">
            <h3 className="text-semibold text-[#02457A] text-lg font-semibold">
              {title}
            </h3>
            <p className="text-sm tracking-wide text-[#02457A]/60">
              Fill in the {type.toLowerCase()} details
            </p>
          </div>
          <button
            className="bg-[#02457A]/5 text-[#02457A] hover:bg-[#02457A] hover:text-white rounded-md p-2 cursor-pointer"
            onClick={closeModal}
          >
            <AiOutlineClose />
          </button>
        ...
        <div className="">
          ...
          />
          <button
            className="w-11/12 max-h-full border-2 border-dashed border-[#02457A]/40 flex flex-col items-center justify-center gap-3 m-5 mb-4 px-4 py-6 text-[#02457A] rounded-xl cursor-pointer"
            ...
            (file &&
              ...
              <>
                ...
                <p className="text-sm font-bold ">
                  Upload a file such as an Invoice
                </p>
                <p className="text-sm text-[#02457A]/80">
          ...
          {error && (
            <p className="text-[13px] px-5 tracking-wide text-red-700">
              *{error}
            </p>
          )}
          <div className="flex gap-2 justify-end items-center mx-5 mb-4">
            <button
              className="text-sm text-[#02457A] font-bold px-4 py-1.5 border-[2px] border-[#02457A]/40 rounded-md cursor-pointer"
              onClick={clearFields}
            >
              Clear
            </button>
            <button
              className="text-sm text-white font-bold px-4 py-2 bg-[#02457A] rounded-md flex justify-center items-center gap-2 cursor-pointer"
              onClick={
                title === "Add Expense" || title === "Add Income"
                  ? addExpense
                  : editExpense
              }
            >
              Done <IoMdCheckmarkCircleOutline className="text-[16px]" />
            </button>
          </div>
        </div>
      </div>
